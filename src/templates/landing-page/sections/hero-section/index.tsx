    ...
    <section className="mt-16 container relative flex items-center justify-center ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          <h1 className="font-sans text-gray-100 text-heading-hg text-center sm:text-left">
            {t("title")}
          </h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-200">{t("text1")}</span>
              </div>
              <div className="flex items-center gap-2">
                <Store className="text-cyan-100 h-4 w-4" />
                <span className="text-gray-200">{t("text2")}</span>
              </div>
            </div>
            <div className="text-white flex flex-col gap-2 mt-5 items-center md:items-start lg:items-start">
              <ButtonSection />
              <p className="text-gray-300 text-body-xs">{t("text3")}</p>
            </div>
          </div>
        </div>
